...
import ownerRatingRoutes from './modules/owner/rating/owner.rating.routes.js';
import ownerCompanyRoutes from './modules/owner/company/owner.company.routes.js';
...
app.use('/api/owner', ownerRatingRoutes);
app.use('/api/owner/company-profile', ownerCompanyRoutes);
